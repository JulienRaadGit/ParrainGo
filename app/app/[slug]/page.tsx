  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {app.slug === 'paypal' && (
          <div className="bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 text-white rounded-2xl p-6 mb-12 text-center shadow-2xl animate-slide-up relative overflow-hidden">
          ...
          <div className="space-y-6">
            {app.howTo.map((step, index) => (
              <div key={index} className="flex items-start gap-6 group">
                <div className="w-12 h-12 bg-gradient-to-br from-primary to-blue-600 text-white rounded-2xl flex items-center justify-center text-lg font-bold flex-shrink-0 shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-110 relative">
          ...
          <div className="space-y-4">
            {app.terms.map((term, index) => (
              <div key={index} className="flex items-start gap-4 group">
                <div className="w-4 h-4 bg-gradient-to-r from-accent to-green-500 rounded-full mt-1 flex-shrink-0 shadow-sm flex items-center justify-center">
          ...
          <div className="bg-gradient-to-br from-slate-900 via-blue-900 to-purple-900 rounded-3xl p-12 text-white shadow-3xl relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <a
                ...
                className="inline-flex items-center gap-3 bg-gradient-to-r from-accent to-green-500 text-white px-12 py-4 rounded-2xl font-bold text-lg shadow-2xl hover:shadow-3xl transform hover:-translate-y-1 transition-all duration-300"
              >
